# CUHK(SZ) SIS GEA 2000 L09 + T23 微信提醒

这是只读、全自动的名额监控器。它会通过学校 Web VPN 自动登录 SIS，查询 `2026-27 Term 1` 的 `GEA 2000`，并在 `L09-LEC(3175)` 与 `T23-TUT(3198)` **同时开放且确有剩余容量**时发送微信通知。
